...
const newProductPools = {
  ...
  'eco-foods': [
    { name: 'Organic Honeycrisp Apples', description: 'Crisp, sweet, and locally harvested apples. Free of synthetic fertilizers.', price: 499, category: 'Produce', images: ['https://images.unsplash.com/photo-1560806887-1e4cd0b6cbd6?w=600'], variants: [{ name: '1kg bag', price: 499, stock: 50 }, { name: '3kg box', price: 1399, stock: 50 }] },
    { name: 'Cold Pressed Avocado Oil', description: '100% pure avocado oil perfect for high-heat cooking, roasting, or salad dressings.', price: 1250, category: 'Pantry', images: ['https://images.unsplash.com/photo-1540420773420-3366772f4999?w=600'], variants: [{ name: '250ml', price: 1250, stock: 20 }, { name: '500ml', price: 2250, stock: 20 }] },
    { name: 'Organic White Quinoa', description: 'Premium organic white quinoa grain. Rich in protein, dietary fiber, and essential minerals.', price: 349, category: 'Pantry', images: ['https://images.unsplash.com/photo-1586201375761-83865001e31c?w=600'], variants: [{ name: '500g Bag', price: 349, stock: 120 }] },
    { name: 'Cold Pressed Coconut Oil', description: '100% pure organic virgin coconut oil cold-pressed from fresh coconuts. Ideal for cooking and skincare.', price: 499, category: 'Pantry', images: ['https://images.unsplash.com/photo-1622484211148-717fa1d0637c?w=600'], variants: [{ name: '500ml Jar', price: 499, stock: 80 }] },
    { name: 'Unsweetened Almond Milk (1L)', description: 'Delicious plant-based milk made from organic Mediterranean almonds. Dairy-free.', price: 299, category: 'Beverages', images: ['https://images.unsplash.com/photo-1553456558-aff63285bdd1?w=600'] },
    { name: 'Raw Organic Chia Seeds (250g)', description: 'Superfood chia seeds rich in Omega-3 fatty acids, protein, and dietary fibers.', price: 249, category: 'Pantry', images: ['https://images.unsplash.com/photo-1586201375761-83865001e31c?w=600'] },
    { name: 'Pure Maple Syrup (Grade A)', description: '100% pure Canadian maple syrup. Rich amber color with a classic robust flavor.', price: 849, category: 'Pantry', images: ['https://images.unsplash.com/photo-1587049352846-4a222e784d38?w=600'] },
    { name: 'Organic Brown Jasmine Rice', description: 'Whole-grain aromatic jasmine rice harvested from certified eco-friendly farms.', price: 189, category: 'Pantry', images: ['https://images.unsplash.com/photo-1586201375761-83865001e31c?w=600'] },
    { name: 'Organic Gluten-Free Rolled Oats', description: 'Premium whole-grain rolled oats. Perfect for a heart-healthy hot breakfast.', price: 220, category: 'Pantry', images: ['https://images.unsplash.com/photo-1586201375761-83865001e31c?w=600'] },
    { name: 'Organic Creamy Peanut Butter', description: 'Made with 100% organic dry-roasted peanuts and a pinch of sea salt. Zero added oils.', price: 349, category: 'Pantry', images: ['https://images.unsplash.com/photo-1590080875515-8a3a8dc5735e?w=600'] },
    { name: 'Extra Virgin Olive Oil (500ml)', description: 'Cold-pressed extra virgin olive oil imported from organic groves in Spain.', price: 1199, category: 'Pantry', images: ['https://images.unsplash.com/photo-1474979266404-7eaacbcd87c5?w=600'] },
    { name: 'Organic Pink Himalayan Salt', description: 'Fine grain, unrefined mineral salt mined from ancient Himalayan geological deposits.', price: 149, category: 'Pantry', images: ['https://images.unsplash.com/photo-1608571423902-eed4a5ad8108?w=600'] },
    { name: 'Organic Whole Wheat Penne', description: 'High-fiber wheat penne pasta extruded through traditional bronze dies.', price: 199, category: 'Pantry', images: ['https://images.unsplash.com/photo-1551462147-ff29053bfc14?w=600'] },
    { name: 'Raw Organic Cashews (500g)', description: 'Crunchy and buttery raw cashew kernels. Non-GMO and unsalted.', price: 699, category: 'Pantry', images: ['https://images.unsplash.com/photo-1586201375761-83865001e31c?w=600'] },
    { name: 'Organic Golden Flaxseeds', description: 'Whole golden flaxseed packed with dietary fiber and heart-healthy fats.', price: 179, category: 'Pantry', images: ['https://images.unsplash.com/photo-1586201375761-83865001e31c?w=600'] },
    { name: 'Vegetable Broth Concentrate', description: 'Organic vegetable reduction base for gourmet soups, gravies, and stews.', price: 249, category: 'Pantry', images: ['https://images.unsplash.com/photo-1547592180-85f173990554?w=600'] },
    { name: 'Chamomile Mint Herbal Tea', description: 'Soothing blend of organic chamomile flowers and fresh peppermint leaves.', price: 290, category: 'Beverages', images: ['https://images.unsplash.com/photo-1597481499750-3e6b22637e12?w=600'] },
    { name: 'Raw Agave Nectar Syrup', description: 'Low-glycemic liquid sweetener extracted from organic blue agave plants.', price: 420, category: 'Pantry', images: ['https://images.unsplash.com/photo-1587049352846-4a222e784d38?w=600'] },
    { name: 'Organic Tri-Color Quinoa', description: 'A gorgeous mix of white, red, and black organic quinoa seeds.', price: 399, category: 'Pantry', images: ['https://images.unsplash.com/photo-1586201375761-83865001e31c?w=600'] },
    { name: 'Cold Pressed Flaxseed Oil', description: 'Pure unrefined cold-pressed flaxseed oil. Must be kept refrigerated.', price: 549, category: 'Pantry', images: ['https://images.unsplash.com/photo-1540420773420-3366772f4999?w=600'] }
  ],
  'organic-india': [
